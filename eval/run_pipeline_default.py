...
def main():
    ...
    # Also persist a per-combo summary file
    summary_path = os.path.join(args.output_dir, "SUMMARY.md")
    summary_default_path = os.path.join(args.output_dir, "SUMMARY_DEFAULT.md")
    try:
        with open(summary_path, "r", encoding="utf-8") as f:
            content = f.read()
        with open(summary_default_path, "w", encoding="utf-8") as f:
            f.write(content)
    except Exception:
        pass
